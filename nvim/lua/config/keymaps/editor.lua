...
--mapping code_runner
map("n", "<F5>", "<cmd>RunCode<cr>", { desc = "Compile and run C++ file" })
...
-- ZK-NVIM keymaps
map("n", "<leader>zn", "<cmd>ZkNew<CR>", { desc = "Create new note" })
map("n", "<leader>zb", "<cmd>ZkBacklinks<CR>", { desc = "Show backlinks" })
map("n", "<leader>zf", "<cmd>ZkNotes<CR>", { desc = "Find ZK notes" })
map("n", "<leader>zt", "<cmd>ZkTags<CR>", { desc = "Search ZK tags" })
map("n", "gd", vim.lsp.buf.definition, { desc = "Go to linked note" })

-- TELEKASTEN keymaps
map("n", "<leader>tt", "<cmd>Telekasten panel<CR>", { desc = "Telekasten panel" })
map("n", "<leader>tn", "<cmd>Telekasten new_note<CR>", { desc = "New Telekasten note" })
map("n", "<leader>td", "<cmd>Telekasten goto_today<CR>", { desc = "Today’s note" })
map("n", "<leader>tf", "<cmd>Telekasten find_notes<CR>", { desc = "Find Telekasten notes" })
map("n", "<leader>tb", "<cmd>Telekasten show_backlinks<CR>", { desc = "Show backlinks" })
